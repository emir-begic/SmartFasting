...
export default function EasyRegistration() {
  return (
    <section className={`${popins.className}  max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row bg-[#FFC65933] mt-12 mb-12 rounded-3xl`}>
        <div className="flex flex-col m-12  w-full h-full">
            <div className="flex flex-col justify-center text-center m-4 gap-4">
                <h1 className="text-[#1C1934] text-5xl font-semibold">Jednostavna registracija</h1>
